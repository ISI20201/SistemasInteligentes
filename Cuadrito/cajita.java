        ...
        if( p.getAttribute(Squares.TURN).equals(color) ){
					...
					if(l<laux) {
						...
						if(((String)p.getAttribute(i+":"+j+":"+Squares.LEFT)).equals(Squares.TRUE)) {
							if(j!=0) {
	            				...
	            				int iaux=i;
	            				int jaux=j-1;
	            				if(((String)p.getAttribute(iaux+":"+jaux+":"+Squares.LEFT)).equals(Squares.TRUE))
	    		                    l3++;
	    						if(((String)p.getAttribute(iaux+":"+jaux+":"+Squares.TOP)).equals(Squares.TRUE))
	    							l3++;
	    						if(((String)p.getAttribute(iaux+":"+jaux+":"+Squares.BOTTOM)).equals(Squares.TRUE))
	    							l3++;
	    						if(((String)p.getAttribute(iaux+":"+jaux+":"+Squares.RIGHT)).equals(Squares.TRUE))
	    							l3++;
            ...
            if(rayas>((size*size*2)-1)) {
            	...
            	if(flag) {
            		...
            		//System.out.println("**********************  Tamaño  ************* "+cuadroAux.size());
            		while(cuadroAux.size()>0){
            			...
            			//System.out.println("**********************  Tamaño V ************* "+v.size()+" **********************  Tamaño aux ************* "+cuadroAux.size());
            			if(v.size()!=0) {
            	...
            	while(v.size()==0 ) {
            		...
            		if(cuadro.size()!=0) {
            			...
            			if(jugadas.size()>0) {
    		        		...
    		        		if(((String)p.getAttribute(i+":"+j+":"+Squares.LEFT)).equals(Squares.FALSE) && (Squares.LEFT).equals(movimiento)) {
    		                    v.add(Squares.LEFT);
    		        		}
    						if(((String)p.getAttribute(i+":"+j+":"+Squares.TOP)).equals(Squares.FALSE) && (Squares.TOP).equals(movimiento)) {
    						  v.add(Squares.TOP);
    						}
    						if(((String)p.getAttribute(i+":"+j+":"+Squares.BOTTOM)).equals(Squares.FALSE) && (Squares.BOTTOM).equals(movimiento)) {
    						  v.add(Squares.BOTTOM);
    						}
    						if(((String)p.getAttribute(i+":"+j+":"+Squares.RIGHT)).equals(Squares.FALSE) && (Squares.RIGHT).equals(movimiento)) {
    						  v.add(Squares.RIGHT);
    						}
    ...
    public void evaluar(Percept p, int i, int j, String move) {
    	...
    	if(cuadroAux.containsKey(llave)) {
    		...
    		if(l>2) {
    			...
    			if(((String)p.getAttribute(i+":"+j+":"+Squares.LEFT)).equals(Squares.FALSE) && !(Squares.LEFT).equals(move)) {
    				evaluar(p, i, (j-1), Squares.RIGHT);
    			}
    			if(((String)p.getAttribute(i+":"+j+":"+Squares.TOP)).equals(Squares.FALSE) && !(Squares.TOP).equals(move)) {
    				evaluar(p, (i-1), j, Squares.BOTTOM);
				}
				if(((String)p.getAttribute(i+":"+j+":"+Squares.BOTTOM)).equals(Squares.FALSE) && !(Squares.BOTTOM).equals(move)) {
					evaluar(p, (i+1), j, Squares.TOP);
				}
				if(((String)p.getAttribute(i+":"+j+":"+Squares.RIGHT)).equals(Squares.FALSE) && !(Squares.RIGHT).equals(move)) {
					evaluar(p, i, (j+1), Squares.LEFT);
				}
    		}
    	}
